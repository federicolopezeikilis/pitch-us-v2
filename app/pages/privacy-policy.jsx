    ...
    return <>
        ...
        <FlexColSection className="flex-1 overflow-y-auto items-center gap-4" >
            <article className="py-4 flex flex-col gap-2">
                    ...
                    <p className="px-4">Al acceder a este sitio web, y de acuerdo a la normativa vigente en materia de protección de datos, le informamos del uso de cookies, dándole la opción de aceptarlas expresamente y de obtener más información a través del contenido de esta página.
                        ...
                        Para su tranquilidad, este sitio web cumple con lo estipulado en la normativa vigente en relación con el uso de las cookies y sus datos personales.</p>
