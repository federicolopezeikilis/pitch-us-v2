    ...
    return <>
        ...
        <FlexColSection className="py-4 flex-1 overflow-y-auto items-center gap-4" >
            <article className="px-4 flex flex-col gap-2">
                ...
                <p>10. El Usuario no utilizará las facilidades que ofrece el Sitio como "repositorio", es decir, que sirvan como almacenamiento de datos para acceder a ellos de cualquier otra forma que no sea a través de las páginas del Sitio. De igual manera, queda prohibido el "acceso remoto" a los contenidos del sitio, definiéndose "acceso remoto" como la inclusión de URIs (Universal Remote Identifiers) que apunten directamente a contenidos internos del Sitio, como imágenes y/o archivos de audio, desde páginas web ajenas al Sitio.</p>
